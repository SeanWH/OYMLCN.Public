        ...
        private static Dictionary<string, string> Dic
        {
            get
            {
                ...
                _dic = new Dictionary<string, string>
                {
                    ...
                    {"biao", "表标彪镖裱飚膘飙镳婊骠飑杓髟鳔灬瘭猋骉"},
                    {"piao", "票朴漂飘嫖瓢剽缥殍瞟骠嘌莩螵"},
                    {"huo", "和活或货获火伙惑霍祸豁嚯藿锪蠖钬耠镬夥灬劐攉嚄喐嚿"},
                    {"bie", "别鳖憋瘪蹩"},
                    {"min", "民敏闽闵皿泯岷悯珉抿黾缗玟愍苠鳘"},
                    {"fen", "分份纷奋粉氛芬愤粪坟汾焚酚吩忿棼玢鼢瀵偾鲼瞓"},
                    {"bing", "并病兵冰屏饼炳秉丙摒柄槟禀枋邴冫靐抦"},
                    {"geng", "更耕颈庚耿梗埂羹哽赓绠鲠"},
                    {"fang", "方放房防访纺芳仿坊妨肪邡舫彷枋鲂匚钫昉"},
                    {"xian", "现先县见线限显险献鲜洗宪纤陷闲贤仙衔掀咸嫌掺羡弦腺痫娴舷馅酰铣冼涎暹籼锨苋蚬跹岘藓燹鹇氙莶霰跣猃彡祆筅顕鱻咁"},
                    {"fou", "不否缶"},
                    {"ca", "拆擦嚓礤"},
                    {"cha", "查察差茶插叉刹茬楂岔诧碴嚓喳姹杈汊衩搽槎镲苴檫馇锸猹"},
                    {"cai", "才采财材菜彩裁蔡猜踩睬啋"},
                    {"can", "参残餐灿惨蚕掺璨惭粲孱骖黪"},
                    {"shen", "信深参身神什审申甚沈伸慎渗肾绅莘呻婶娠砷蜃哂椹葚吲糁渖诜谂矧胂珅屾燊"},
                    {"cen", "参岑涔"},
                    {"san", "三参散伞叁糁馓毵"},
                    {"cang", "藏仓苍沧舱臧伧"},
                    {"zang", "藏脏葬赃臧奘驵"},
                    {"chen", "称陈沈沉晨琛臣尘辰衬趁忱郴宸谌碜嗔抻榇伧谶龀肜棽"},
                    {"cao", "草操曹槽糙嘈漕螬艚屮"},
                    {"ce", "策测册侧厕栅恻"},
                    {"ze", "责则泽择侧咋啧仄箦赜笮舴昃迮帻"},
                    {"zhai", "债择齐宅寨侧摘窄斋祭翟砦瘵哜"},
                    ...
                    {"shan", "山单善陕闪衫擅汕扇掺珊禅删膳缮赡鄯栅煽姗跚鳝嬗潸讪舢苫疝掸膻钐剡蟮芟埏彡骟羴"},
                    {"zhan", "展战占站崭粘湛沾瞻颤詹斩盏辗绽毡栈蘸旃谵搌"},
                    {"xin", "新心信辛欣薪馨鑫芯锌忻莘昕衅歆囟忄镡馫"},
                    {"lian", "联连练廉炼脸莲恋链帘怜涟敛琏镰濂楝鲢殓潋裢裣臁奁莶蠊蔹"},
                    {"chang", "场长厂常偿昌唱畅倡尝肠敞倘猖娼淌裳徜昶怅嫦菖鲳阊伥苌氅惝鬯玚"},
                    ...
                    {"cheng", "成程城承称盛抢乘诚呈净惩撑澄秤橙骋逞瞠丞晟铛埕塍蛏柽铖酲裎枨琤"},
                    {"rong", "容荣融绒溶蓉熔戎榕茸冗嵘肜狨蝾瑢"},
                    {"sheng", "生声升胜盛乘圣剩牲甸省绳笙甥嵊晟渑眚焺珄昇湦陹竔琞"},
                    {"deng", "等登邓灯澄凳瞪蹬噔磴嶝镫簦戥"},
                    {"zhi", "制之治质职只志至指织支值知识直致执置止植纸拓智殖秩旨址滞氏枝芝脂帜汁肢挚稚酯掷峙炙栉侄芷窒咫吱趾痔蜘郅桎雉祉郦陟痣蛭帙枳踯徵胝栀贽祗豸鸷摭轵卮轾彘觯絷跖埴夂黹忮骘膣踬臸"},
                    {"zheng", "政正证争整征郑丁症挣蒸睁铮筝拯峥怔诤狰徵钲掟"},
                    {"tang", "堂唐糖汤塘躺趟倘棠烫淌膛搪镗傥螳溏帑羰樘醣螗耥铴瑭"},
                    {"chi", "持吃池迟赤驰尺斥齿翅匙痴耻炽侈弛叱啻坻眙嗤墀哧茌豉敕笞饬踟蚩柢媸魑篪褫彳鸱螭瘛眵傺"},
                    {"shi", "是时实事市十使世施式势视识师史示石食始士失适试什泽室似诗饰殖释驶氏硕逝湿蚀狮誓拾尸匙仕柿矢峙侍噬嗜栅拭嘘屎恃轼虱耆舐莳铈谥炻豕鲥饣螫酾筮埘弑礻蓍鲺贳湜"},
                    {"qi", "企其起期气七器汽奇齐启旗棋妻弃揭枝歧欺骑契迄亟漆戚岂稽岐琦栖缉琪泣乞砌祁崎绮祺祈凄淇杞脐麒圻憩芪伎俟畦耆葺沏萋骐鳍綦讫蕲屺颀亓碛柒啐汔綮萁嘁蛴槭欹芑桤丌蜞"},
                    {"chuai", "揣踹啜搋膪"},
                    {"tuo", "托脱拓拖妥驼陀沱鸵驮唾椭坨佗砣跎庹柁橐乇铊沲酡鼍箨柝"},
                    {"duo", "多度夺朵躲铎隋咄堕舵垛惰哆踱跺掇剁柁缍沲裰哚隳"},
                    {"xue", "学血雪削薛穴靴谑噱鳕踅泶彐"},
                    {"chong", "重种充冲涌崇虫宠忡憧舂茺铳艟蟲翀"},
                    {"chou", "筹抽绸酬愁丑臭仇畴稠瞅踌惆俦瘳雠帱"},
                    {"qiu", "求球秋丘邱仇酋裘龟囚遒鳅虬蚯泅楸湫犰逑巯艽俅蝤赇鼽糗"},
                    {"xiu", "修秀休宿袖绣臭朽锈羞嗅岫溴庥馐咻髹鸺貅飍"},
                    {"chu", "出处础初助除储畜触楚厨雏矗橱锄滁躇怵绌搐刍蜍黜杵蹰亍樗憷楮"},
                    {"tuan", "团揣湍疃抟彖"},
                    {"zhui", "追坠缀揣椎锥赘惴隹骓缒"},
                    {"chuan", "传川船穿串喘椽舛钏遄氚巛舡"},
                    {"zhuan", "专转传赚砖撰篆馔啭颛孨"},
                    {"yuan", "元员院原源远愿园援圆缘袁怨渊苑宛冤媛猿垣沅塬垸鸳辕鸢瑗圜爰芫鼋橼螈眢箢掾厵"},
                    {"cuan", "窜攒篡蹿撺爨汆镩"},
                    {"chuang", "创床窗闯幢疮怆"},
                    {"zhuang", "装状庄壮撞妆幢桩奘僮戆壵"},
                    {"chui", "吹垂锤炊椎陲槌捶棰"},
                    ...
                    {"cu", "促趋趣粗簇醋卒蹴猝蹙蔟殂徂麤"},
                    {"dun", "吨顿盾敦蹲墩囤沌钝炖盹遁趸砘礅"},
                    {"qu", "区去取曲趋渠趣驱屈躯衢娶祛瞿岖龋觑朐蛐癯蛆苣阒诎劬蕖蘧氍黢蠼璩麴鸲磲佢"},
                    {"xu", "需许续须序徐休蓄畜虚吁绪叙旭邪恤墟栩絮圩婿戌胥嘘浒煦酗诩朐盱蓿溆洫顼勖糈砉醑媭珝昫"},
                    {"chuo", "辍绰戳淖啜龊踔辶"},
                    {"zu", "组族足祖租阻卒俎诅镞菹"},
                    ...
                    {"wei", "为位委未维卫围违威伟危味微唯谓伪慰尾魏韦胃畏帷喂巍萎蔚纬潍尉渭惟薇苇炜圩娓诿玮崴桅偎逶倭猥囗葳隗痿猬涠嵬韪煨艉隹帏闱洧沩隈鲔軎烓"},
                    {"cun", "村存寸忖皴"},
                    {"zuo", "作做座左坐昨佐琢撮祚柞唑嘬酢怍笮阼胙咗"},
                    {"zuan", "钻纂攥缵躜"},
                    {"da", "大达打答搭沓瘩惮嗒哒耷鞑靼褡笪怛妲龘"},
                    {"dai", "大代带待贷毒戴袋歹呆隶逮岱傣棣怠殆黛甙埭诒绐玳呔迨"},
                    {"tai", "大台太态泰抬胎汰钛苔薹肽跆邰鲐酞骀炱"},
                    {"ta", "他它她拓塔踏塌榻沓漯獭嗒挞蹋趿遢铊鳎溻闼譶"},
                    ...
                    {"jie", "家结解价界接节她届介阶街借杰洁截姐揭捷劫戒皆竭桔诫楷秸睫藉拮芥诘碣嗟颉蚧孑婕疖桀讦疥偈羯袷哜喈卩鲒骱劼吤"},
                    {"yan", "研严验演言眼烟沿延盐炎燕岩宴艳颜殷彦掩淹阎衍铅雁咽厌焰堰砚唁焉晏檐蜒奄俨腌妍谚兖筵焱偃闫嫣鄢湮赝胭琰滟阉魇酽郾恹崦芫剡鼹菸餍埏谳讠厣罨啱"},
                    {"dang", "当党档荡挡宕砀铛裆凼菪谠氹"},
                    {"tao", "套讨跳陶涛逃桃萄淘掏滔韬叨洮啕绦饕鼗弢"},
                    ...
                    {"tui", "推退弟腿褪颓蜕忒煺"},
                    {"you", "有由又优游油友右邮尤忧幼犹诱悠幽佑釉柚铀鱿囿酉攸黝莠猷蝣疣呦蚴莸莜铕宥繇卣牖鼬尢蚰侑甴"},
                    {"dian", "电点店典奠甸碘淀殿垫颠滇癫巅惦掂癜玷佃踮靛钿簟坫阽"},
                    {"tian", "天田添填甜甸恬腆佃舔钿阗忝殄畋栝掭瑱"},
                    {"zhu", "主术住注助属逐宁著筑驻朱珠祝猪诸柱竹铸株瞩嘱贮煮烛苎褚蛛拄铢洙竺蛀渚伫杼侏澍诛茱箸炷躅翥潴邾槠舳橥丶瘃麈疰"},
                    {"nian", "年念酿辗碾廿捻撵拈蔫鲶埝鲇辇黏惗唸"},
                    {"diao", "调掉雕吊钓刁貂凋碉鲷叼铫铞"},
                    {"yao", "要么约药邀摇耀腰遥姚窑瑶咬尧钥谣肴夭侥吆疟妖幺杳舀窕窈曜鹞爻繇徭轺铫鳐崾珧垚峣"},
                    {"die", "跌叠蝶迭碟爹谍牒耋佚喋堞瓞鲽垤揲蹀"},
                    {"she", "设社摄涉射折舍蛇拾舌奢慑赦赊佘麝歙畲厍猞揲滠"},
                    {"ye", "业也夜叶射野液冶喝页爷耶邪咽椰烨掖拽曳晔谒腋噎揶靥邺铘揲嘢"},
                    {"xie", "些解协写血叶谢械鞋胁斜携懈契卸谐泄蟹邪歇泻屑挟燮榭蝎撷偕亵楔颉缬邂鲑瀣勰榍薤绁渫廨獬躞劦"},
                    {"zhe", "这者着著浙折哲蔗遮辙辄柘锗褶蜇蛰鹧谪赭摺乇磔螫晢喆嚞嗻啫"},
                    {"ding", "定订顶丁鼎盯钉锭叮仃铤町酊啶碇腚疔玎耵掟"},
                    {"diu", "丢铥"},
                    {"ting", "听庭停厅廷挺亭艇婷汀铤烃霆町蜓葶梃莛"},
                    {"dong", "动东董冬洞懂冻栋侗咚峒氡恫胴硐垌鸫岽胨"},
                    {"tong", "同通统童痛铜桶桐筒彤侗佟潼捅酮砼瞳恸峒仝嗵僮垌茼"},
                    {"zhong", "中重种众终钟忠仲衷肿踵冢盅蚣忪锺舯螽夂"},
                    {"dou", "都斗读豆抖兜陡逗窦渎蚪痘蔸钭篼唞"},
                    {"du", "度都独督读毒渡杜堵赌睹肚镀渎笃竺嘟犊妒牍蠹椟黩芏髑"},
                    {"duan", "断段短端锻缎煅椴簖"},
                    {"dui", "对队追敦兑堆碓镦怼憝"},
                    {"rui", "瑞兑锐睿芮蕊蕤蚋枘"},
                    {"yue", "月说约越乐跃兑阅岳粤悦曰钥栎钺樾瀹龠哕刖曱"},
                    {"tun", "吞屯囤褪豚臀饨暾氽"},
                    {"hui", "会回挥汇惠辉恢徽绘毁慧灰贿卉悔秽溃荟晖彗讳诲珲堕诙蕙晦睢麾烩茴喙桧蛔洄浍虺恚蟪咴隳缋哕烜翙"},
                    {"wu", "务物无五武午吴舞伍污乌误亡恶屋晤悟吾雾芜梧勿巫侮坞毋诬呜钨邬捂鹜兀婺妩於戊鹉浯蜈唔骛仵焐芴鋈庑鼯牾怃圬忤痦迕杌寤阢沕"},
                    {"ya", "亚压雅牙押鸭呀轧涯崖邪芽哑讶鸦娅衙丫蚜碣垭伢氩桠琊揠吖睚痖疋迓岈砑"},
                    {"he", "和合河何核盖贺喝赫荷盒鹤吓呵苛禾菏壑褐涸阂阖劾诃颌嗬貉曷翮纥盍翯"},
                    ...
                    {"fei", "费非飞肥废菲肺啡沸匪斐蜚妃诽扉翡霏吠绯腓痱芾淝悱狒榧砩鲱篚镄飝"},
                    {"pei", "配培坏赔佩陪沛裴胚妃霈淠旆帔呸醅辔锫"},
                    {"ping", "平评凭瓶冯屏萍苹乒坪枰娉俜鲆"},
                    {"fo", "佛"},
                    {"hu", "和护许户核湖互乎呼胡戏忽虎沪糊壶葫狐蝴弧瑚浒鹄琥扈唬滹惚祜囫斛笏芴醐猢怙唿戽槲觳煳鹕冱瓠虍岵鹱烀轷"},
                    {"ga", "夹咖嘎尬噶旮伽尕钆尜呷"},
                    {"ge", "个合各革格歌哥盖隔割阁戈葛鸽搁胳舸疙铬骼蛤咯圪镉颌仡硌嗝鬲膈纥袼搿塥哿虼吤嗰"},
                    {"ha", "哈蛤铪"},
                    ...
                    {"hong", "红宏洪轰虹鸿弘哄烘泓訇蕻闳讧荭黉薨轟"},
                    {"guang", "广光逛潢犷胱咣桄"},
                    {"qiong", "穷琼穹邛茕筇跫蛩銎"},
                    {"gao", "高告搞稿膏糕镐皋羔锆杲郜睾诰藁篙缟槁槔"},
                    {"hao", "好号毫豪耗浩郝皓昊皋蒿壕灏嚎濠蚝貉颢嗥薅嚆"},
                    {"li", "理力利立里李历例离励礼丽黎璃厉厘粒莉梨隶栗荔沥犁漓哩狸藜罹篱鲤砺吏澧俐骊溧砾莅锂笠蠡蛎痢雳俪傈醴栎郦俚枥喱逦娌鹂戾砬唳坜疠蜊黧猁鬲粝蓠呖跞疬缡鲡鳢嫠詈悝苈篥轹刕嚟"},
                    {"jia", "家加价假佳架甲嘉贾驾嫁夹稼钾挟拮迦伽颊浃枷戛荚痂颉镓笳珈岬胛袈郏葭袷瘕铗跏蛱恝哿"},
                    {"luo", "落罗络洛逻螺锣骆萝裸漯烙摞骡咯箩珞捋荦硌雒椤镙跞瘰泺脶猡倮蠃囖啰"},
                    {"ke", "可科克客刻课颗渴壳柯棵呵坷恪苛咳磕珂稞瞌溘轲窠嗑疴蝌岢铪颏髁蚵缂氪骒钶锞"},
                    {"qia", "卡恰洽掐髂袷咭葜"},
                    {"gei", "给"},
                    {"gen", "根跟亘艮哏茛"},
                    {"hen", "很狠恨痕哏"},
                    {"gou", "构购够句沟狗钩拘勾苟垢枸篝佝媾诟岣彀缑笱鞲觏遘玽"},
                    {"kou", "口扣寇叩抠佝蔻芤眍筘"},
                    ...
                    {"ne", "呢哪呐讷疒"},
                    {"gui", "规贵归轨桂柜圭鬼硅瑰跪龟匮闺诡癸鳜桧皈鲑刽晷傀眭妫炅庋簋刿宄匦攰"},
                    ...
                    {"kan", "看刊勘堪坎砍侃嵌槛瞰阚龛戡凵莰"},
                    {"heng", "衡横恒亨哼珩桁蘅"},
                    {"mo", "万没么模末冒莫摩墨默磨摸漠脉膜魔沫陌抹寞蘑摹蓦馍茉嘿谟秣蟆貉嫫镆殁耱嬷麽瘼貊貘尛"},
                    {"peng", "鹏朋彭膨蓬碰苹棚捧亨烹篷澎抨硼怦砰嘭蟛堋"},
                    {"hou", "后候厚侯猴喉吼逅篌糇骺後鲎瘊堠"},
                    {"hua", "化华划话花画滑哗豁骅桦猾铧砉舙"},
                    {"huai", "怀坏淮徊槐踝"},
                    {"huan", "还环换欢患缓唤焕幻痪桓寰涣宦垸洹浣豢奂郇圜獾鲩鬟萑逭漶锾缳擐嬛"},
                    {"xun", "讯训迅孙寻询循旬巡汛勋逊熏徇浚殉驯鲟薰荀浔洵峋埙巽郇醺恂荨窨蕈曛獯灥"},
                    ...
                    {"nan", "南难男楠喃囡赧腩囝蝻婻暔"},
                    {"qian", "前千钱签潜迁欠纤牵浅遣谦乾铅歉黔谴嵌倩钳茜虔堑钎骞阡掮钤扦芊犍荨仟芡悭缱佥愆褰凵肷岍搴箝慊椠汧"},
                    ...
                    {"xiao", "小效销消校晓笑肖削孝萧俏潇硝宵啸嚣霄淆哮筱逍姣箫骁枭哓绡蛸崤枵魈婋虓皛啋"},
                    {"si", "司四思斯食私死似丝饲寺肆撕泗伺嗣祀厮驷嘶锶俟巳蛳咝耜笥纟糸鸶缌澌姒汜厶兕"},
                    {"kai", "开凯慨岂楷恺揩锴铠忾垲剀锎蒈嘅"},
                    {"jin", "进金今近仅紧尽津斤禁锦劲晋谨筋巾浸襟靳瑾烬缙钅矜觐堇馑荩噤廑妗槿赆衿卺"},
                    {"qin", "亲勤侵秦钦琴禽芹沁寝擒覃噙矜嗪揿溱芩衾廑锓吣檎螓骎"},
                    {"jing", "经京精境竞景警竟井惊径静劲敬净镜睛晶颈荆兢靖泾憬鲸茎腈菁胫阱旌粳靓痉箐儆迳婧肼刭弪獍璟誩競"},
                    {"ying", "应营影英景迎映硬盈赢颖婴鹰荧莹樱瑛蝇萦莺颍膺缨瀛楹罂荥萤鹦滢蓥郢茔嘤璎嬴瘿媵撄潆煐媖暎锳"},
                    {"jiu", "就究九酒久救旧纠舅灸疚揪咎韭玖臼柩赳鸠鹫厩啾阄桕僦鬏"},
                    {"zui", "最罪嘴醉咀蕞觜"},
                    {"juan", "卷捐圈眷娟倦绢隽镌涓鹃鄄蠲狷锩桊"},
                    {"suan", "算酸蒜狻"},
                    {"yun", "员运云允孕蕴韵酝耘晕匀芸陨纭郧筠恽韫郓氲殒愠昀菀狁沄"},
                    {"qun", "群裙逡麇"},
                    {"ka", "卡喀咖咔咯佧胩"},
                    {"kang", "康抗扛慷炕亢糠伉钪闶"},
                    {"keng", "坑铿吭"},
                    ...
                    {"mi", "米密秘迷弥蜜谜觅靡泌眯麋猕谧咪糜宓汨醚嘧弭脒冖幂祢縻蘼芈糸敉沕"},
                    {"men", "们门闷瞒汶扪焖懑鞔钔"},
                    {"mang", "忙盲茫芒氓莽蟒邙硭漭"},
                    {"meng", "蒙盟梦猛孟萌氓朦锰檬勐懵蟒蜢虻黾蠓艨甍艋瞢礞"},
                    {"miao", "苗秒妙描庙瞄缪渺淼藐缈邈鹋杪眇喵冇"},
                    {"mou", "某谋牟缪眸哞鍪蛑侔厶踎"},
                    {"miu", "缪谬"},
                    {"mei", "美没每煤梅媒枚妹眉魅霉昧媚玫酶镁湄寐莓袂楣糜嵋镅浼猸鹛"},
                    {"wen", "文问闻稳温纹吻蚊雯紊瘟汶韫刎璺玟阌揾"},
                    {"mie", "灭蔑篾乜咩蠛"},
                    {"ming", "明名命鸣铭冥茗溟酩瞑螟暝"},
                    {"na", "内南那纳拿哪娜钠呐捺衲镎肭乸"},
                    {"nei", "内那哪馁"},
                    ...
                    {"nang", "囊馕囔曩攮"},
                    {"nao", "脑闹恼挠瑙淖孬垴铙桡呶硇猱蛲嫐"},
                    {"ni", "你尼呢泥疑拟逆倪妮腻匿霓溺旎昵坭铌鲵伲怩睨猊妳"},
                    {"nen", "嫩恁"},
                    {"neng", "能"},
                    {"nin", "您恁"},
                    {"niao", "鸟尿溺袅脲茑嬲"},
                    {"nie", "摄聂捏涅镍孽捻蘖啮蹑嗫臬镊颞乜陧聶"},
                    {"niang", "娘酿"},
                    {"ning", "宁凝拧泞柠咛狞佞聍甯寗"},
                    {"nu", "努怒奴弩驽帑孥胬"},
                    {"nv", "女钕衄恧"},
                    ...
                    {"pin", "品贫聘频拼拚颦姘嫔榀牝"},
                    {"se", "色塞瑟涩啬穑铯槭歮"},
                    {"qing", "情青清请亲轻庆倾顷卿晴氢擎氰罄磬蜻箐鲭綮苘黥圊檠謦甠暒凊郬靘"},
                    {"zan", "赞暂攒堑昝簪糌瓒錾趱拶"},
                    {"shao", "少绍召烧稍邵哨韶捎勺梢鞘芍苕劭艄筲杓潲"},
                    {"sao", "扫骚嫂梢缫搔瘙臊埽缲鳋"},
                    {"sha", "沙厦杀纱砂啥莎刹杉傻煞鲨霎嗄痧裟挲铩唼歃"},
                    {"xuan", "县选宣券旋悬轩喧玄绚渲璇炫萱癣漩眩暄煊铉楦泫谖痃碹揎镟儇烜翾昍"},
                    {"ran", "然染燃冉苒髯蚺"},
                    {"rang", "让壤攘嚷瓤穰禳"},
                    {"rao", "绕扰饶娆桡荛"},
                    {"reng", "仍扔"},
                    ...
                    {"weng", "翁嗡瓮蓊蕹"},
                    {"zhua", "抓挝爪"},
                    {"yang", "样养央阳洋扬杨羊详氧仰秧痒漾疡泱殃恙鸯徉佯怏炀烊鞅蛘玚旸飏"},
                    {"xiong", "雄兄熊胸凶匈汹芎"},
                    {"yo", "哟唷"},
