...
namespace OYMLCN.WeChat
{
    public partial class Api
    {
        ...
        public class Mass
        {
            public static string CreateJson(string type, string data, int tagId = 0, bool sendIgnoreReprint = false, List<string> openid = null, string previewOpenId = null, string previewWeixinName = null)
            {
            ...
            public static MassResult PreviewMpNews(AccessToken token, string mediaId, string openid = null, string wxname = null) =>
                SendPreview(token, CreateJson("mpnews", mediaId, 0, false, null, openid, wxname));
            ...
            public static MassResult PreviewText(AccessToken token, string text, string openid = null, string wxname = null) =>
                SendPreview(token, CreateJson("text", text, 0, false, null, openid, wxname));
            ...
            {
                if (type == MediaType.Image || type == MediaType.Video || type == MediaType.Voice)
                    return SendOpenId(token, CreateJson(type.ToString().ToLower(), mediaId, 0, false, openid));
                throw new NotSupportedException("非媒体内容请使用对应的方法发送");
            }
            public static MassResult PreviewMedia(AccessToken token, MediaType type, string mediaId, string openid = null, string wxname = null)
            {
                if (type == MediaType.Image || type == MediaType.Video || type == MediaType.Voice)
                    return SendPreview(token, CreateJson(type.ToString().ToLower(), mediaId, 0, false, null, openid, wxname));
                throw new NotSupportedException("非媒体内容请使用对应的方法发送");
            }
            ...
            public static MassResult PreviewCard(AccessToken token, string cardId, string openid = null, string wxname = null) =>
                SendPreview(token, CreateJson("wxcard", cardId, 0, false, null, openid, wxname));
