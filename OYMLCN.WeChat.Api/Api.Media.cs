...
namespace OYMLCN.WeChat
{
    public partial class Api
    {
        public class Media
        {
            ...
            public static string GetUrl(string access_token, MediaType type, string mediaId)
            {
                string url = ApiUrl("/cgi-bin/media/get?access_token={0}&media_id={1}", access_token, mediaId);
            ...
            public static string SpeexDownloadUrl(string access_token, string mediaId) =>
                ApiUrl("/cgi-bin/media/get/jssdk?access_token={0}&media_id={1}", access_token, mediaId);
        }
    }
}
