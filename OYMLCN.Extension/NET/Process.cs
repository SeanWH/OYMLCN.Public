...
namespace OYMLCN
{
    ...
    public static class ProcessCommunicate
    {
        ...
        public static class IpcChannel
        {
            ...
            /// <param name="uri">方法名</param>
            /// <param name="mode"></param>
            public static void RegisterServiceChannel(Type type, string portName, string uri, WellKnownObjectMode mode = WellKnownObjectMode.Singleton)
            {
            ...
            /// <param name="portName">服务名</param>
            /// <param name="uri">方法名</param>
            public static void RegisterClientChannel(Type type, string portName, string uri)
            {
                ChannelServices.RegisterChannel(new System.Runtime.Remoting.Channels.Ipc.IpcChannel(), false);
                RemotingConfiguration.RegisterWellKnownClientType(new WellKnownClientTypeEntry(type, $"ipc://{portName}/{uri}"));
