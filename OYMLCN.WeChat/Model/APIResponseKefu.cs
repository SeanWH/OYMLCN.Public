...
namespace OYMLCN.WeChat.Model
{
    ...
    /// 客服账号信息
    /// </summary>
    public class KefuInfo : JsonResult
    {
        /// <summary>
    ...
    public class KefuList : JsonResult
    {
        ...
        /// 账号列表
        /// </summary>
        public KefuInfo[] kf_list { get; set; }
        /// <summary>
        /// 在线账号列表
        /// </summary>
        public KefuInfo[] kf_online_list { get; set; }
    }

    /// <summary>
    /// 客户会话状态
    /// </summary>
    public class KefuSession : JsonResult
    {
        /// <summary>
        /// 正在接待的客服，为空表示没有人在接待
        /// </summary>
    ...
    public class KefuSessionList : JsonResult
    {
        ...
        /// 客服会话列表
        /// </summary>
        public KefuSession[] sessionlist { get; set; }
        /// <summary>
        /// 未接入会话列表，最多返回100条数据，按照来访顺序
        /// </summary>
        public KefuSession[] waitcaselist { get; set; }
        /// <summary>
        /// 未接入会话数量
        /// </summary>
    ...
    public class KefuRecordList : JsonResult
    {
        ...
        /// 聊天记录
        /// </summary>
        public KefuRecord[] recordlist { get; set; }
        /// <summary>
        /// 消息条数
        /// </summary>
