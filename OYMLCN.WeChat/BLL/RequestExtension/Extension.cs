...
namespace OYMLCN.WeChat
{
    ...
    public static partial class Extension
    {
        ...
        /// <returns></returns>
        public static string CreateSignature(string timestamp, string nonce, string token, string msg = null) =>
        ...
        /// <returns></returns>
        public static string GetErrorCodeDescription(this int errcode) => ErrorDescription.Where(d => d.Key == errcode).Select(d => d.Value).FirstOrDefault();
    }
}
