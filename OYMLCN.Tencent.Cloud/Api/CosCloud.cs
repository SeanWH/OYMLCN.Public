...
using OYMLCN.Tencent.Cloud.Util;
using System.Web;
using System.IO;
...
namespace OYMLCN.Tencent.Cloud
{
    /// <summary>
    ...
    public class CosCloud
    {
        ...
        {
            this.appId = configuration.GetValue<int>("TencentCloud:AppId");
            this.secretId = configuration.GetValue<string>("TencentCloud:SecretId");
            this.secretKey = configuration.GetValue<string>("TencentCloud:SecretKey");
            this.timeOut = HTTP_TIMEOUT_TIME * 1000;
