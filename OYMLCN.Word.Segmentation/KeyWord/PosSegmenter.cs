...
namespace OYMLCN.Word.KeyWord
{
    public class PosSegmenter
    {
        ...
        static PosSegmenter() => LoadWordTagTab();
        ...
        public PosSegmenter() => _segmenter = new Segmenter();

        public PosSegmenter(Segmenter segmenter) => _segmenter = segmenter;
        ...
        public IEnumerable<Pair> Cut(string text, bool hmm = true) => CutInternal(text, hmm);
